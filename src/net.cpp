...
/*
addrConnect.SetIP(CNetAddr("127.0.0.1"));
addrConnect.SetPort(6333);
*/
    /// debug print
...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Nbcoin " + FormatFullVersion();
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Nbcoin is probably already running."), addrBind.ToString().c_str());
        else
