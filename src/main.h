...
static const unsigned int MAX_BLOCK_SIZE_GEN = MAX_BLOCK_SIZE/4; //NBCOIN
/** The maximum size for transactions we're willing to relay/mine */
static const unsigned int MAX_STANDARD_TX_SIZE = MAX_BLOCK_SIZE_GEN/2.5; //NBCOIN
...
inline bool AllowFree(double dPriority)
{
    ...
    // need a fee.
    return dPriority > COIN * 576 / 250; ///144*4 NBcoin
}
