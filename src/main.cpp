...
const string strMessageMagic = "Nbcoin Signed Message:\n";
...
static const int64 nTargetTimespan = 3.5 * 24 * 60 * 60; //NBcoin: 3.5 days
static const int64 nTargetSpacing = 2.5 * 60; //NBcoin: 2.5 minutes
...
bool CheckBlock(const CBlock& block, CValidationState& state, bool fCheckPOW, bool fCheckMerkleRoot)
{
    ...
    {
	    ////printf("time1:%d,time2:%d", block.GetBlockTime(),GetAdjustedTime());
